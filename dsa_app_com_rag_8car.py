# Mini-Projeto 8 - IA Generativa, LLM e RAG Para Assistente Financeiro em Python com LangChain
...
st.title("⚖️ Assistente Financeiro (Com o Uso de RAG)")
...
# Este Mini-Projeto é um exemplo simples de aplicação RAG (Retrieval-Augmented Generation) na área Financeira.
